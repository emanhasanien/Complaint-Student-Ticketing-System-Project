      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <NavLink className="nav-link" aria-current="page" to={"/طالب/لوحة التحكم" }>الرئيسية</NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link" to={"/طالب/تقديم شكوي"}>تقديم شكوي</NavLink>
          </li>

          <li className="nav-item">
            <NavLink className="nav-link" to={"/طالب/الشكاوي" }>الشكاوي</NavLink>
          </li>
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to={'/طالب/التواصل مع الدعم'}>التواصل مع الدعم</NavLink>
          </li>
